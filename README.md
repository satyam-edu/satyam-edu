...
[Hotel Kamala Inn Grand](https://github.com/satyam-edu) · Jul 2026
...
**Graphic Design & UI Design Intern**
Pephot Solutions · Remote · Jul 2025 – Oct 2025

Designed 70+ social media creatives, banners, and emailers maintaining brand consistency. Collaborated with marketing teams to convert design concepts into production-ready assets using Figma, Photoshop, and Illustrator.
...
| **[Binance Futures Testnet Bot](https://github.com/satyam-edu)** — *GitHub* | Python · REST APIs · HMAC-SHA256 | CLI trading bot for Binance Futures USDT-M Testnet with signed requests and audit logging |
...
> A production-ready CLI to place and manage orders on the Binance Futures USDT-M Testnet via direct REST API calls.

- 🔏 **Custom HMAC-SHA256 request signing** — no third-party SDK dependency
- 📋 **Structured logging** — full audit trail for every order and API call
- ⌨️ Built with **argparse** for a clean, scriptable command-line interface
